...
function GameStart(){
  ...
  this.rankBtn = new PIXI.Sprite(loader.resources["_assets/"+folderName+"/start_game_rank_btn.png"].texture);
  this.addChild(this.rankBtn);
  this.rankBtn.anchor.x = 0.5;
  this.rankBtn.anchor.y = 0.5;
  this.rankBtn.x = GAME_WIDTH/2;
  this.rankBtn.y = GAME_HEIGHT * 0.15;
  ...
  this.startGameBtn.y = GAME_HEIGHT*0.72;
  this.startGameBtn.interactive = true;
  this.btnAni;
  this.clickType = "";
  ...
  this.transitionIn = function(){
    ...
    this.startWord = new PIXI.Sprite(loader.resources["_assets/"+folderName+"/start_game_word.png"].texture);
    this.addChild(this.startWord);
    this.startWord.anchor.x = 0.5;
    this.startWord.anchor.y = 0.5;
    this.startWord.x = GAME_WIDTH/2;
    this.startWord.y = GAME_HEIGHT*0.47;
